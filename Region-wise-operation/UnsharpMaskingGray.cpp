...
int main() {
	...
	output_z = unsharpmask(input_gray, 1, 1, 1, "zero-paddle", 0.5); //Boundary process: zero-paddle, mirroring, adjustkernel
	output_m = unsharpmask(input_gray, 1, 1, 1, "mirroring", 0.5);
	output_a = unsharpmask(input_gray, 1, 1, 1, "adjustkernel", 0.5);
