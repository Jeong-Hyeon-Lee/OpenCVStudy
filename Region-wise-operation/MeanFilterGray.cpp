...
int main() {
	...
	output_z = meanfilter(input_gray, 3, "zero-paddle");
	output_m = meanfilter(input_gray, 3, "mirroring");
	output_a = meanfilter(input_gray, 3, "adjustkernel");

	namedWindow("Mean Filter_Zero-paddle", WINDOW_AUTOSIZE);
	imshow("Mean Filter_Zero-paddle", output_z);

	namedWindow("Mean Filter_Mirroring", WINDOW_AUTOSIZE);
	imshow("Mean Filter_Mirroring", output_m);

	namedWindow("Mean Filter_AdjustKernel", WINDOW_AUTOSIZE);
	imshow("Mean Filter_AdjustKernel", output_a);
