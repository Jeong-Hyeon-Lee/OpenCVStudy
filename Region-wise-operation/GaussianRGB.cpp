...
int main() {
	...
	output_z = gaussianfilter(input, 1, 1, 1, "zero-paddle"); //Boundary process: zero-paddle, mirroring, adjustkernel
	output_m = gaussianfilter(input, 1, 1, 1, "mirroring");
	output_a = gaussianfilter(input, 1, 1, 1, "adjustkernel");
